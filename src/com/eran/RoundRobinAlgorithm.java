            ...
            for (int t2 = 0; t2 <=1 ; t2++) {
                for (int t3 = 0; t3 <=1 ; t3++) {
                    for (int t4 = 0; t4 <=1 ; t4++) {
                        if (t1 == 1 && coalition.contains(tm1) && tm1 != team && tournamentGraph[tm1.getTeamNumber()-1][team.getTeamNumber()])
                        {
                            tm1.setScore(tm1.getScore() - 3);
                            team.setScore(team.getScore() + 3);
                        }
                        if (t2 == 1 && coalition.contains(tm2) && tm2 != team && tournamentGraph[tm2.getTeamNumber()-1][team.getTeamNumber()])
                        {
                            tm2.setScore(tm2.getScore() - 3);
                            team.setScore(team.getScore() + 3);
                        }
                        if (t3 == 1 && coalition.contains(tm3) && tm1 != team && tournamentGraph[tm3.getTeamNumber()-1][team.getTeamNumber()])
                        {
                            tm3.setScore(tm3.getScore() - 3);
                            team.setScore(team.getScore() + 3);
                        }
                        if (t4 == 1 && coalition.contains(tm4) && tm4 != team && tournamentGraph[tm4.getTeamNumber()-1][team.getTeamNumber()])
                        {
                            tm4.setScore(tm4.getScore() - 3);
                            team.setScore(team.getScore() + 3);
                        }
                        groupOfTeam.getTeams().sort();
                        if ((team == groupOfTeam.getTeams().get(0) || team == groupOfTeam.getTeams().get(1)) && !pairsList.contains(new Pair(groupOfTeam.getTeams().get(0), groupOfTeam.getTeams().get(1))) {
                            pairsList.add(new Pair(groupOfTeam.getTeams().get(0), groupOfTeam.getTeams().get(1)));
                            System.out.println(groupOfTeam.getTeams().get(0).getNumber() + "," + groupOfTeam.getTeams().get(1).getNumber());
                        }
                        initListOfGroupsScores(tournamentGraph, listOfGroups);
                    }
                }
